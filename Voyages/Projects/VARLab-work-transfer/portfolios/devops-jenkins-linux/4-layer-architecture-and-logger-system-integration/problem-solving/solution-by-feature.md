...
1. [Bitbucket API Migration](#1-bitbucket-api-migration)
2. [Shell Script Libraries](#2-shell-script-libraries)
3. [Stage Modularization](#3-stage-modularization)
4. [Testability](#4-testability)
5. [Logger System Integration](#5-logger-system-integration)
